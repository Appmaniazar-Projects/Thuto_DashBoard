...
// Dummy database for academic reports
    ...
    <Box sx={{ p: 3 }}>
      <Paper sx={{ p: 3, mb: 3 }}>
        ...
        <Typography variant="body1" color="text.secondary" paragraph>
          View and download your academic reports and progress summaries
        </Typography>
              ...
              <>
                ...
                <Grid container spacing={2} sx={{ mb: 3 }}>
                  <Grid item xs={12} sm={6} md={3}>
                    ...
                    <Typography variant="body1">Emma Thompson</Typography>
                  </Grid>
                  <Grid item xs={12} sm={6} md={3}>
                ...
                <Box sx={{ mb: 3 }}>
                  ...
                  <Typography variant="body1">{report.attendanceRate}%</Typography>
                </Box>
                
                <Box>
                  <Typography variant="body2" color="text.secondary">Teacher's Comment:</Typography>
                  <Typography variant="body1" paragraph>{report.teacherComment}</Typography>
                </Box>
              </>
            );
          })()}
